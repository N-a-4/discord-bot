...
And you can place one button or one thumbnail component next to it!`))
    .setButtonAccessory(btn => btn.setLabel("Button inside a Section").setCustomId("btn:btn-1758033482148").setStyle(ButtonStyle.Secondary).setEmoji({ id: emojis.handshake_mix.id }))
  )
